...
```{r setup, include=FALSE}
knitr::opts_knit$set(root.dir = "~/Downloads/research/")
```
...
hist(tot_samples, main = "Histogram of posterior samples of total effects of X3 on X1")
```
...
hist(path_samples, main = "Histogram of posterior samples of the effect of X3 on X1 through X2")
```

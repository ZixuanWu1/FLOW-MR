...
// gibbs_sampler_new
List gibbs_sampler_new(arma::mat& Y, arma::mat& Sd_hat, arma::mat& trait_corr, int& N, arma::mat& B, double& sigma, arma::vec& sigma1, arma::vec& sigma0, arma::vec& p, arma::mat& A, arma::umat& Z, double& alpha_B, double& beta_B, arma::vec& alpha_0, arma::vec& alpha_1, arma::vec& beta_0, arma::vec& beta_1, arma::vec& a, arma::vec& b, arma::mat& Lambda3, arma::mat& Lambda_inv3, arma::vec& num_traits);
RcppExport SEXP _FLOWMR_gibbs_sampler_new(SEXP YSEXP, SEXP Sd_hatSEXP, SEXP trait_corrSEXP, SEXP NSEXP, SEXP BSEXP, SEXP sigmaSEXP, SEXP sigma1SEXP, SEXP sigma0SEXP, SEXP pSEXP, SEXP ASEXP, SEXP ZSEXP, SEXP alpha_BSEXP, SEXP beta_BSEXP, SEXP alpha_0SEXP, SEXP alpha_1SEXP, SEXP beta_0SEXP, SEXP beta_1SEXP, SEXP aSEXP, SEXP bSEXP, SEXP Lambda3SEXP, SEXP Lambda_inv3SEXP, SEXP num_traitsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat& >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< arma::mat& >::type Lambda3(Lambda3SEXP);
    Rcpp::traits::input_parameter< arma::mat& >::type Lambda_inv3(Lambda_inv3SEXP);
    Rcpp::traits::input_parameter< arma::vec& >::type num_traits(num_traitsSEXP);
    rcpp_result_gen = Rcpp::wrap(gibbs_sampler_new(Y, Sd_hat, trait_corr, N, B, sigma, sigma1, sigma0, p, A, Z, alpha_B, beta_B, alpha_0, alpha_1, beta_0, beta_1, a, b, Lambda3, Lambda_inv3, num_traits));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_FLOWMR_gibbs_sampler_new", (DL_FUNC) &_FLOWMR_gibbs_sampler_new, 22},
    {NULL, NULL, 0}
};
